                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-white">
                            ...
                            <div class="panel-body">
                                ...
                                <form id="form" action="{{ route('postCustomerEdit',['id' => $result->id??'0','code' => $module->code]) }}"
                                    ...
                                    <fieldset class="content-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                ...
                                                <input name="lastname" type="text" class="form-control"
                                                       ...
                                                       value="{{ $result->lastname??old('lastname') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                ...
                                                <input type="number" name="discount" class="form-control"
                                                       ...
                                                       value="{{ $result->discount??old('discount') }}" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                ...
                                                <select name="group" class="select-search" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                ...
                                                <select name="gender" class="select-fixed-single" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                ...
                                                <input name="email" type="email" class="form-control"
                                                       ...
                                                       value=" {{ $result->email??old('email') }}"

                                                       placeholder="Poçt adresi" required>
