                        ...
                        <div class="panel panel-white">
                            ...
                            <div class="panel-body">
                                ...
                                @if ($errors->any())
                                    ...
                                    @endforeach
                                @endif
                                <form id="form" action="{{ route('postRegionCountryEdit',['id' => 0,'code' => $module->code]) }}" class="form-horizontal" method="post" accept-charset="utf-8">
                                    @csrf
                                    <fieldset class="content-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input name="code" type="text" required class="form-control" value="{{ old('code') }}" placeholder="Kod">
                                            </div>
                                        </div>
                                        <div class="form-group">
