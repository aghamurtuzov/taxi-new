                        ...
                        <div class="panel-body">
                            @if(Session::has('success-message'))
                                ...
                                @if ($errors->any())
                                    ...
                                    @endforeach
                                @endif
                            <form id="form" action="{{ route('postRegionDistrictEdit',['id' => $result->id,'code' => $module->code]) }}" class="form-horizontal" method="post" accept-charset="utf-8">
                                @csrf
                            <fieldset class="content-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <select name="city" class="select-search form-control" required>
