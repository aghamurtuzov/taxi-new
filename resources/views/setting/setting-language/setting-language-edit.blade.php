                        ...
                        <div class="panel-body">
                              @if(Session::has('success-message'))
                                ...
                                @if ($errors->any())
                                    ...
                                    @endforeach
                                @endif
                               <form id="form" action="{{ route('postSettingLanguageEdit',['id' => $result->id,'code' => $module->code]) }}" class="form-horizontal" method="post" accept-charset="utf-8">
                                @csrf
                            <fieldset class="content-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="code" type="text" required class="form-control" value="{{$result->code}}" placeholder="Kod">
                                    </div>
                                </div>
                                <div class="form-group">
